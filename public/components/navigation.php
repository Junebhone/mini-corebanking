...
<div id="nav"
    class="bg-gray-800 z-10 text-blue-100 w-60   space-y-6 py-7 px-2 fixed inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-500 ease-in-out">
    <!--     logo -->
