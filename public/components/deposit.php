<div class="w-full p-5">
    <div class="my-5">
        <h2 class="text-4xl font-semibold leading-tight">Deposit</h2>
    </div>
            ...
            <tbody class="divide-y divide-gray-100 text-center">
                ...
                <tr>
                    ...
                    <td class="py-4 text-gray-700 whitespace-nowrap flex gap-5 justify-center  items-center">
                        <a href="./deposit_form.php?accountID=<?= $result['accountID'] ?>"
                            class="bg-green-400 text-white px-4 py-2 rounded-md cursor-pointer">Deposit</a>
                    </td>
                </tr>
                <?php
                }
