...
<div class=" p-5 w-full">
    <form autocomplete="off" action="./deposit_form.php" method="POST" enctype="multipart/form-data">
        <div class="bg-white rounded-md shadow-md  overflow-hidden">
            <div class="p-10">
                <div class="flex justify-start items-center mb-5">
                    <span class="text-green-800 text-4xl font-semibold leading-tight">Deposit Form</span>
                </div>
